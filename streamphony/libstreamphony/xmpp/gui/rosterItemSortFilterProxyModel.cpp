...
RosterItemSortFilterProxyModel::RosterItemSortFilterProxyModel(const RosterItemSortFilterProxyModel &other) : RosterItemSortFilterProxyModel()
{
    m_showOfflineContacts = other.m_showOfflineContacts;
    m_sortByName = other.m_sortByName;
}
